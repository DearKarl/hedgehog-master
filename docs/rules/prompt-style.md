...
> Style rules for files under `skills/hedgehog-master/references/`. Follow these when writing or reviewing role definitions and shared specs.
...
|---|---|
| A role reference (Image_X / Strategist-style) | [`image-searcher.md`](../skills/hedgehog-master/references/image-searcher.md), [`strategist.md`](../skills/hedgehog-master/references/strategist.md) |
| A shared spec across roles | [`image-base.md`](../skills/hedgehog-master/references/image-base.md), [`shared-standards.md`](../skills/hedgehog-master/references/shared-standards.md) |
| A technical / format spec | [`canvas-formats.md`](../skills/hedgehog-master/references/canvas-formats.md), [`svg-image-embedding.md`](../skills/hedgehog-master/references/svg-image-embedding.md), [`image-layout-spec.md`](../skills/hedgehog-master/references/image-layout-spec.md) |
| Workflow runbook | [`workflows/verify-charts.md`](../skills/hedgehog-master/workflows/verify-charts.md) |
