...
| Rule | Scope |
|---|---|
| [`prompt-style.md`](./prompt-style.md) | Style guide for files under `skills/hedgehog-master/references/` — voice, sectioning, table-first, forbidden patterns |
| [`code-style.md`](./code-style.md) | Style guide for Python under `skills/hedgehog-master/scripts/` — file headers, imports, CLI entry points, error handling, no-tests rule |
