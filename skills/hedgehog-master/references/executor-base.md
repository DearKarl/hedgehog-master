...
```bash
ls skills/hedgehog-master/templates/icons/chunk-filled/ | grep home
ls skills/hedgehog-master/templates/icons/tabler-filled/ | grep home
ls skills/hedgehog-master/templates/icons/tabler-outline/ | grep chart
ls skills/hedgehog-master/templates/icons/phosphor-duotone/ | grep house
ls skills/hedgehog-master/templates/icons/simple-icons/ | grep github
```
