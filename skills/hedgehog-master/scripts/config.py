...
USER_CONFIG_DIR = Path.home() / '.hedgehog-master'
...
SVG_CONSTRAINTS = {
    'authority': 'skills/hedgehog-master/references/shared-standards.md',
    'validator': 'skills/hedgehog-master/scripts/svg_quality_checker.py',
}
