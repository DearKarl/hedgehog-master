#!/usr/bin/env python3
"""
Hedgehog Master - Visual Review Renderer
...
def main() -> int:
    ...
    try:
        ...
        _safe_print(
            ...
            '(see skills/hedgehog-master/requirements.txt)'
        )
        return 3
    ...
    try:
        ...
        _safe_print(
            'start it with:\n'
            f'    python3 skills/hedgehog-master/scripts/svg_editor/server.py {project_path}'
        )
        return 2
