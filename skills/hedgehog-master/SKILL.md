---
name: hedgehog-master
description: >
  Local-first research presentation harness for evidence-linked academic English,
  deterministic scientific diagrams, publication SVG, and editable PPTX. Use for
  research talks, paper figures, flowcharts, source-grounded decks, and presentation work.
---
...
```bash
python3 hedgehog.py init <project> --demo
python3 hedgehog.py validate <project>
python3 hedgehog.py build <project>
python3 hedgehog.py export <project>
```
...
>
> - `hedgehog-master` is a repository-specific workflow, not a general application scaffold
