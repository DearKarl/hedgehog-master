#!/usr/bin/env python3
"""
Hedgehog Master - Speaker Notes Splitting Tool
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description='Hedgehog Master - Speaker Notes Splitting Tool',
...
'''
    ...
    if verbose:
        print("Hedgehog Master - Speaker Notes Splitting Tool")
        print("=" * 50)
